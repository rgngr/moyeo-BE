...
public class RedisConfig {
    ...
    private final String EmailCreate = "EmailCreate";
    private final int EMAIL_CREATE = 30;
    @Bean
...
//        cacheConfiguration.put(EmailCreate,RedisCacheConfiguration.defaultCacheConfig()
//                .entryTtl(Duration.ofSeconds(EMAIL_CREATE)));
